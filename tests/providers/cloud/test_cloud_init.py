...
class TestCloudPackageImport:
    ...
    def test_cloud_package_importable(self) -> None:
        """madakit.providers.cloud is importable without error."""
        import madakit.providers.cloud as cloud  # noqa: F401

        assert cloud is not None

    def test_cloud_package_is_module(self) -> None:
        """The cloud package object is a Python module."""
        import madakit.providers.cloud as cloud
...
class TestExplicitProviderImports:
    ...
    def test_openai_module_importable(self) -> None:
        """madakit.providers.cloud.openai is importable."""
        mod = importlib.import_module("madakit.providers.cloud.openai")
        assert mod is not None

    def test_anthropic_module_importable(self) -> None:
        """madakit.providers.cloud.anthropic is importable."""
        mod = importlib.import_module("madakit.providers.cloud.anthropic")
        assert mod is not None

    def test_gemini_module_importable(self) -> None:
        """madakit.providers.cloud.gemini is importable."""
        mod = importlib.import_module("madakit.providers.cloud.gemini")
        assert mod is not None

    def test_deepseek_module_importable(self) -> None:
        """madakit.providers.cloud.deepseek is importable."""
        mod = importlib.import_module("madakit.providers.cloud.deepseek")
        assert mod is not None

    def test_openai_client_importable_from_explicit_path(self) -> None:
        """OpenAIClient is importable from madakit.providers.cloud.openai."""
    ...
    def test_anthropic_client_importable_from_explicit_path(self) -> None:
        """AnthropicClient is importable from madakit.providers.cloud.anthropic."""
    ...
    def test_gemini_client_importable_from_explicit_path(self) -> None:
        """GeminiClient is importable from madakit.providers.cloud.gemini."""
    ...
    def test_deepseek_client_importable_from_explicit_path(self) -> None:
        """DeepSeekClient is importable from madakit.providers.cloud.deepseek."""
