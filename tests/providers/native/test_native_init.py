...
class TestNativePackageImport:
    ...
    def test_native_package_importable_via_importlib(self) -> None:
        ...
        native = importlib.import_module("madakit.providers.native")
        assert native is not None
...
class TestExplicitProviderImports:
    ...
    def test_llamacpp_module_importable(self) -> None:
        """madakit.providers.native.llamacpp is importable."""
        import madakit.providers.native.llamacpp as mod  # noqa: F401
    ...
    def test_transformers_module_importable(self) -> None:
        """madakit.providers.native.transformers is importable."""
        import madakit.providers.native.transformers as mod  # noqa: F401
