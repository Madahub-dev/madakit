...
def migrate_langchain(source_code: str) -> str:
    ...
    result = re.sub(
        ...
        r"from mada_modelkit.providers.cloud.\1 import \1Client",
        result,
    )
    result = re.sub(
    ...
    if "AgentRequest" in result and "from mada_modelkit" not in result:
        result = "from mada_modelkit._types import AgentRequest\n" + result
