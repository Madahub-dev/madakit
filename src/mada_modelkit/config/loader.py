...
class ConfigLoader:
    ...
    def build_stack(config: StackConfig) -> BaseAgentClient:
        ...
        from mada_modelkit import middleware as mw_module

        # Provider type mapping
        provider_map = {
            "openai": ("mada_modelkit.providers.cloud.openai", "OpenAIClient"),
            "anthropic": ("mada_modelkit.providers.cloud.anthropic", "AnthropicClient"),
            "gemini": ("mada_modelkit.providers.cloud.gemini", "GeminiClient"),
            "deepseek": ("mada_modelkit.providers.cloud.deepseek", "DeepSeekClient"),
            "ollama": ("mada_modelkit.providers.local_server.ollama", "OllamaClient"),
            "vllm": ("mada_modelkit.providers.local_server.vllm", "VllmClient"),
            "localai": ("mada_modelkit.providers.local_server.localai", "LocalAIClient"),
            "llamacpp": ("mada_modelkit.providers.native.llamacpp", "LlamaCppClient"),
            "transformers": ("mada_modelkit.providers.native.transformers", "TransformersClient"),
        }
